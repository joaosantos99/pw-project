		...
		>
			...
			>
				<div class="flex items-center gap-2">
					<component :is="Bot" size="20" aria-hidden="true" />
					<span id="chatbot-title" class="font-semibold">Chat Assistant</span>
				</div>
				<div class="flex items-center gap-2">
					<button
					...
					>
						<component :is="RotateCcw" size="18" aria-hidden="true" />
					</button>
					<button
						@click="handleClose"
						class="cursor-pointer hover:opacity-80 transition-opacity"
					...
					>
						<component :is="X" size="20" aria-hidden="true" />
					</button>
				</div>
			</div>
			...
			>
				...
				>
					<div
						...
						:role="message.sender === 'user' ? 'status' : undefined"
					>
			...
			<div class="border-t border-brand-primary p-4">
				<div class="flex gap-2">
					...
					>
						<component :is="Send" size="18" aria-hidden="true" />
					</button>
				</div>
			</div>
		</div>
